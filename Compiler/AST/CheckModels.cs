public static class FunctionParamsModels
{
    ...
    public static void Init()
    {
        ...
        paramModels["Move"] = [returnType.number, returnType.number];
        ...
        paramModels["IsCanvasColor"] = [returnType.text, returnType.number, returnType.number];
